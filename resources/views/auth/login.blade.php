@extends('admin_layouts.login_header')
@section('content')
<div id="main" role="main">

      <!-- MAIN CONTENT -->

      <form class="lockscreen animated flipInY" method="post" enctype="multipart/form-data" action="{{ route('login') }}">
        ...
        <div>
          ...
          <div>
            <h1><i class="fa fa-user fa-3x text-muted air air-top-right hidden-mobile"></i>Admin Login </h1>
              ...
              <input class="form-control" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Email">
